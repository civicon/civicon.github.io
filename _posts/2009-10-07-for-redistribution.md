...
It is important to remember, that we all depend on the reliability of these consumption checks. 
...
So there really is no reason to assume that redistribution done right would hurt economic growth one bit. 
